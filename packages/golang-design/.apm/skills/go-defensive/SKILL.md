...
Inject dependencies instead of mutating package-level variables.
...
> Read [references/GLOBAL-STATE.md](references/GLOBAL-STATE.md) when designing the New() + Default() package state pattern or replacing mutable globals with dependency injection.
