...
Specify container capacity where possible to allocate memory up front.
...
**Exceptions**: Large structs where copying is expensive, or small structs that might grow in the future.
